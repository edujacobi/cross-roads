...
exports.run = async (bot, message, args) => {
    ...
    if (option === 'alterar') {
        ...
        let total = classesEscolhidas.ladrao + classesEscolhidas.advogado + classesEscolhidas.mafioso +
            classesEscolhidas.empresario + classesEscolhidas.assassino + classesEscolhidas.mendigo
