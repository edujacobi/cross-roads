...
exports.run = async (bot, message, args) => {
	...
	message.channel.send({
		...
		Object.values(e).forEach(emoji => msg.react(emoji).catch(err => console.log("Não consegui reagir mensagem `top` reação " + emoji)))
	...
	}).catch(err => console.log("Não consegui enviar mensagem `top`"))
};
exports.config = {
	alias: ['ranking', 'rank']
};