...
exports.run = async (bot, interaction) => {
	...
	const embed = new Discord.MessageEmbed()
		...
		.addField("Precisa fazer o registro anti-fake?", "Acesse o servidor oficial e use qualquer comando na categoria GAMEPLAY!", true)
...
exports.commandData = new SlashCommandBuilder()
	.setName('ajuda')
	.setDescription('Mostra informações iniciais de como jogar')
